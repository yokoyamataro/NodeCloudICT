...
interface ProjectListState {
  ...
  updateProject: (id: string, updates: Partial<Pick<Project, 'name' | 'description' | 'client' | 'contractor' | 'coordinate_zone' | 'category' | 'started_at' | 'completed_at' | 'visibility'>>) => Promise<void>
